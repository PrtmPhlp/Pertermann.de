---
title: Geldautomat als Pythonskript
...
PEP8[^1] konformes Pythonskript zur Wechselgeldberechnung eines Geldbetrages in Euro und Cent
...
- Es wird auf zwei Nachkommastellen gerundet um Floatingpointfehler zu vermeiden[^2]
...
Das Basis Skript ist jetzt in zwei Teile eingeteilt: Die eigentliche Funktion als `berechne_wechselgeld()` und _alles andere_
...
Das testing framework Unittest ist seit Python Version 2.1 in den Standart Bibliotheken integriert.
Durch die leichte Definition von Testabläufen, können wir Programme so mit Leichtigkeit auf ihre Robustheit testen.
